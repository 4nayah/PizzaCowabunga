...
public class PizzaServiceImpl implements PizzaService{
	...
	public PizzaServiceImpl() {
		...
		listePizzas.add(new Pizza(2, "nature", "Sortez aussi léger que lorsque vous êtes entré.", 10.99, Base64Converter.encodeFileToBase64Binary("src/main/resources/static/img/pizza-nature.png")));
		listePizzas.add(new Pizza(3, "lardon-confiture", "Alliance subtile de saveurs s'approchant dangereusement du mauvais goût.", 12.50, Base64Converter.encodeFileToBase64Binary("src/main/resources/static/img/pizza-lardon-confiture.png")));
